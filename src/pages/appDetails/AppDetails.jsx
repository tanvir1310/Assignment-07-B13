...
const AppDetails = () => {
  ...
  // সেফটি চেকসহ কনটেক্সট ডাটা নেওয়া
  ...
  const handleQuickCheckIn = (type) => {
    ...
    // ফাংশনাল আপডেট ব্যবহার করা হয়েছে যাতে এরর না আসে
    ...
    <div className="bg-[#F8FAFC] min-h-screen py-12 px-4">
      <div className="container mx-auto max-w-5xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          {/* প্রোফাইল সেকশন (ইমেজ অনুযায়ী বাম পাশ) */}
          ...
          {/* স্ট্যাটস ও কুইক চেক-ইন (ইমেজ অনুযায়ী ডান পাশ) */}
          <div className="lg:col-span-8 space-y-6">
            {/* ৩টি কার্ড লজিক (Days Since, Goal, Next Due) */}
